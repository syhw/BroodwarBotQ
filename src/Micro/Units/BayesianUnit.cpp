...
void BayesianUnit::baseMicro()
{
}

void BayesianUnit::zealotMicro()
{
...
void BayesianUnit::dragoonIA(std::set<Unit*> enemies, double maxRangeGoonEnemy)
{
    for each(Unit* enemy in enemies)
    {
...
void BayesianUnit::dragoonMicro()
{
    std::set<Unit*> enemies;
    int damagesTaken = 0;
    fillEnemies(enemies, damagesTaken);
